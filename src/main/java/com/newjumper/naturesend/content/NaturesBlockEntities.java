...
public class NaturesBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NaturesHangingSignBlockEntity>> NATURES_HANGING_SIGNS = BLOCK_ENTITIES.register("natures_hanging_signs", () -> BlockEntityType.Builder.of(NaturesHangingSignBlockEntity::new, NaturesBlocks.WILLOW_HANGING_SIGN.get(), NaturesBlocks.WILLOW_WALL_HANGING_SIGN.get()).build(null));
}
