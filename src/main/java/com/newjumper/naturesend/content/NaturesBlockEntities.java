...
public class NaturesBlockEntities {
    ...
    public static final RegistryObject<BlockEntityType<NaturesSignBlockEntity>> NATURES_SIGNS = BLOCK_ENTITIES.register("natures_signs", () -> BlockEntityType.Builder.of(NaturesSignBlockEntity::new, NaturesBlocks.EVERGREEN_SIGN.get(), NaturesBlocks.EVERGREEN_WALL_SIGN.get(), NaturesBlocks.SHADOW_SIGN.get(), NaturesBlocks.SHADOW_WALL_SIGN.get(), NaturesBlocks.WILLOW_SIGN.get(), NaturesBlocks.WILLOW_WALL_SIGN.get()).build(null));
    public static final RegistryObject<BlockEntityType<NaturesHangingSignBlockEntity>> NATURES_HANGING_SIGNS = BLOCK_ENTITIES.register("natures_hanging_signs", () -> BlockEntityType.Builder.of(NaturesHangingSignBlockEntity::new, NaturesBlocks.EVERGREEN_HANGING_SIGN.get(), NaturesBlocks.EVERGREEN_WALL_HANGING_SIGN.get(), NaturesBlocks.SHADOW_HANGING_SIGN.get(), NaturesBlocks.SHADOW_WALL_HANGING_SIGN.get(), NaturesBlocks.WILLOW_HANGING_SIGN.get(), NaturesBlocks.WILLOW_WALL_HANGING_SIGN.get()).build(null));
}
