package com.newjumper.naturesend.content.items;
...
public class NaturesBoatItem extends BoatItem {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final String WOOD_TYPE;
    private final boolean HAS_CHEST;

    public NaturesBoatItem(boolean pHasChest, Properties pProperties, WoodType pType) {
    ...
    private Boat getBoat(Level level, HitResult hitResult) {
        return HAS_CHEST ? new NaturesChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE) : new NaturesBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z, WOOD_TYPE);
    }
}
