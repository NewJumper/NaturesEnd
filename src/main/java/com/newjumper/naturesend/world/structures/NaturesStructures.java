...
public class NaturesStructures {
    ...
    public static void bootstrap(BootstapContext<Structure> context) {
        ...
        context.register(VILLAGE_JUNGLE, new JigsawStructure(structure(biomes.getOrThrow(NaturesTags.Biomes.HAS_VILLAGE_JUNGLE)), pools.getOrThrow(PlainVillagePools.START), 6, ConstantHeight.of(VerticalAnchor.absolute(0)), true, Heightmap.Types.WORLD_SURFACE_WG));
    }
