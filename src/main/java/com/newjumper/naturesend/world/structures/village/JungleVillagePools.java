...
public class JungleVillagePools {
    ...
    public static void bootstrap(BootstapContext<StructureTemplatePool> context) {
        ...
        context.register(createKey("village/jungle/houses"), new StructureTemplatePool(terminator, ImmutableList.of(Pair.of(location("village/jungle/houses/jungle_small_house_1", mossy), 1), Pair.of(location("village/jungle/houses/jungle_small_house_2", mossy), 1), Pair.of(location("village/jungle/houses/jungle_small_house_3", mossy), 1), Pair.of(location("village/jungle/houses/jungle_small_house_4", mossy), 1), Pair.of(location("village/jungle/houses/jungle_small_house_5", mossy), 1), Pair.of(location("village/jungle/houses/jungle_small_house_6", mossy), 1), Pair.of(location("village/jungle/houses/jungle_medium_house_1", mossy), 1), Pair.of(location("village/jungle/houses/jungle_medium_house_2", mossy), 1), Pair.of(location("village/jungle/houses/jungle_big_house_1", mossy), 1), Pair.of(location("village/jungle/houses/jungle_farm_1", mossy), 1), Pair.of(location("village/jungle/houses/jungle_farm_2", mossy), 1), Pair.of(location("village/jungle/houses/jungle_animal_pen_1", mossy), 1), Pair.of(location("village/jungle/houses/jungle_animal_pen_2", mossy), 1), Pair.of(location("village/jungle/houses/jungle_animal_pen_3", mossy), 1), Pair.of(location("village/jungle/houses/jungle_accessory_1", mossy), 1), Pair.of(StructurePoolElement.empty(), 4)), StructureTemplatePool.Projection.RIGID));
